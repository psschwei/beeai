...
def create_agent():
    model_id = os.getenv("LITELLM_MODEL_ID", "ollama/llama3.1")
    model_params = {
...
async def register_agent() -> int:
    ...
    @server.agent(
        ...
        **Metadata(
            ...
            license="Apache 2.0",
            languages=["Python"],
            githubUrl="https://github.com/psschwei/beeai.git@add-hf-research-agent#subdirectory=agents/community/open-deep-research-agent",
            ui=UiDefinition(
